...
*Osservazione* : l'Host Provider (Infinity Free) per gli account non premium non consente di utilizzare Stored Procedures e Triggers. A causa di ciò, nel codice PHP sono state usate delle query normali per fare le operazioni sql.s
